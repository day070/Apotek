                                ...
                                <div class="card-body">
                                    <form action="proses_tambah_data.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="id_supplier" id="id_supplier" list="id_supplier" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="kategori_obat" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stok_obat" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="mb-3">
