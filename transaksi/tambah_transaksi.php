                                ...
                                <div class="card-body">
                                    <form action="proses_tambah_data.php" method="post">
                                        <datalist id="id_pelanggan">
                                            <?php
                                            include("../conn.php");
                                            $list = mysqli_query($conn, "SELECT nama_lengkap FROM tb_pelanggan");
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="id_pelanggan" id="id_pelanggan" list="id_pelanggan" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="mb-3">
