                                ...
                                <div class="card-body">
                                    <form action="proses_tambah_data.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="telp" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Usia</label>
                                            <input type="number" name="usia" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Foto Resep</label>
                                            <input type="file" name="resep" accept=".jpg, .jpeg, .png" class="form-control" autocomplete="off">
                                        </div>
